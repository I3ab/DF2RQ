...
def visualize(args, model, recorder, result):
    ...
    path = args.data_dir + '/image_patch/' + args.filename + '.jpg'
    image = mmcv.imread(path, 'color')
...
def main():
    ...
    """
    imgs = dict(
        rgb_path=args.data_dir + '/image_patch/' + args.filename + '.jpg',
        dem_path=args.data_dir + '/dem_patch/' + args.filename + '.tif',
        ndvi_path=args.data_dir + '/ndvi_patch/' + args.filename + '.tif',
        vvvh_path=args.data_dir + '/vvvh_patch/' + args.filename + '.tif',
        seg_map_path=args.data_dir + '/label_patch/' + args.filename + '.png',
    )
    with recorder:
